...
<body style="background-color: rgb(5, 5, 66)">
    <div class="account-pages my-5 pt-sm-5"style="background-color: rgb(5, 5, 66)">
      ...
      <p> Please Complete All Fields</p>
                                 ...
                                 <form method="POST" action="{{route('step2')}}" id="regester" class="needs-validation" novalidate>
                            @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="invalid-feedback">
                                     ...
                                     <div class="mb-3">
                                    <label for="useremail" class="form-label">Post Code</label>
                                    <input type="text" class="form-control" id="address" name="pcode" placeholder="Enter Post Code" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="mt-4 d-grid">
                                    <button class="btn btn-success waves-effect waves-light"  onclick='create(this)' type="submit" id="div" style="background-color: rgb(5, 5, 66)"">Next</button>
                                </div><br>
                                <p class="response"></p>
