        ...
        <!--            </div> .nk-block-head -->
			  ...
			  <div class="modal-footer bg-lighter">
                    <div class="text-center w-100">
                        ...
                        <p><button name="cancel" class="link link-danger" ><a href="{{url('withdrawal')}}">Cancel Order</a></button></p>
				...
				<div class="nk-modal">
                   ...
                   @endif
					  ...
					  <div class="nk-modal-text">
						...
						<input required type="text" name="account_name" class="form-control form-control-lg form-control-number" placeholder="Recipient Name"><br>
						<input required type="text" name="account_number" class="form-control form-control-lg form-control-number" placeholder="Account Number"><br>
						<input required type="text" name="bank_name" class="form-control form-control-lg form-control-number" placeholder="Bank Name"><br>
						<input required type="text" name="bank_country" class="form-control form-control-lg form-control-number" placeholder="Country"><br>
						<input required type="text" name="bank_routing_number" class="form-control form-control-lg form-control-number" placeholder="Bank Routing/SWIFT Number"><br>
