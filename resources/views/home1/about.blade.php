...
<head>
    ...
    <title>About Us | Valeris Crest</title>
    ...
    <style>
        ...
        * {
        ...
        /* About Hero Section */
        .about-hero {
            background: linear-gradient(rgba(255,255,255,0.85), rgba(255,255,255,0.72)), url('https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80') center/cover no-repeat;
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="abt-us-write">
                        ...
                        <br />
                        <p class="t-p">
                            Valeris Crest is founded with vision to create 100% transparent digital trading experience for its clients.
                        </p>
                        <br />
                        <p class="t-p">
            ...
            <div class="row justify-content-center">
                <div class="col-md-10 col-sm-12">
                    ...
                    <p class="t-p text-center">
                        Valeris Crest is an Optimal Wealth Management Company with emphasis on Wealth Management, Wealth Creation, Trades and Digital Assets usage. We offer various insured services capable of generating and returning good profit yield on crypto assets in the Blockchain through trading on a wide range of Instrument Categories. Valeris Crest has qualified financiers/traders that manage and provide financial consulting services to her investors. We pride ourselves with a world class professional customer service, unique trading strategies, optimum transparency and fidelity. Funds Invested with Valeris Crest can be Withdrawn, Transferred or Reinvested at will.
                    </p>
                </div>
            </div>
        </div>
