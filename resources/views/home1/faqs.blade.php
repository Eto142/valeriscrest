    ...
    <style>
        ...
        * {
        ...
        .faq-accordion .accordion-button:not(.collapsed) {
            background-color: rgba(82, 175, 238, 0.08);
            color: var(--primary);
                ...
                <div class="accordion" id="generalAccordion">
                    <div class="accordion-item">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#generalAccordion">
                            <div class="accordion-body">
                                There are risks in Trading all assets, that is exactly why there is Valeris Crest. All trade risks are borne by us. If there is any loss that stalls the trading, the Investor will be Refunded his Capital.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#generalAccordion">
                            <div class="accordion-body">
                                Deposits and Withdrawals to and from Valeris Crest are processed through Bitcoin & Ethereum.
                            </div>
                        </div>
                    </div>
                </div>
