...
<head>
    ...
    <title>Contact Us | Valeris Crest</title>
    ...
    <style>
        ...
        * {
        ...
        .contact-hero {
            background: linear-gradient(rgba(255,255,255,0.85), rgba(255,255,255,0.72)), url('https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80') center/cover no-repeat;
