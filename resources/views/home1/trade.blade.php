...
<head>
    ...
    <title>Live Trading | Valeris Crest</title>
    ...
    <style>
        ...
        * {
        ...
        /* Trade Hero Section */
        .trade-hero {
            background: linear-gradient(rgba(255,255,255,0.85), rgba(255,255,255,0.72)), url('https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80') center/cover no-repeat;
