                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="background:linear-gradient(135deg,#059669,#10b981); padding:32px 40px; text-align:center;">
                                        ...
                                        <h1 style="margin:0; color:#ffffff; font-size:22px; font-weight:700; letter-spacing:0.3px;">Deposit Approved</h1>
                                        <p style="margin:8px 0 0; color:rgba(255,255,255,0.85); font-size:14px;">Your deposit has been confirmed successfully</p>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td style="padding:36px 40px;">
                                        ...
                                        <p style="margin:0 0 24px; color:#374151; font-size:15px; line-height:1.7;">
                                            Hello! Great news  your deposit has been reviewed and <strong style="color:#059669;">approved</strong>. The funds are now reflected in your account.
                                        </p>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" style="background:#f8fafc; border-radius:10px; border:1px solid #e2e8f0; margin-bottom:28px;">
                                            <tr>
                                                <td style="padding:20px 24px;">
                                                    ...
                                                    <p style="margin:0; font-size:28px; font-weight:800; color:#059669;">${{ number_format($data['amount'], 2) }}</p>
                                                </td>
                                            </tr>
                                        </table>

                                        <p style="margin:0 0 8px; color:#6b7280; font-size:14px; line-height:1.7;">
                                            Log in to your dashboard to view your updated balance and transaction history.
                                        </p>
