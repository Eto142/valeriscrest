...
.form-title { font-size: 1.55rem; font-weight: 800; margin: 0 0 6px; color: #111111; }
.form-sub { color: #4f4f4f; font-size: 0.92rem; margin: 0 0 16px; }
...
.form-control, .form-select {
    ...
    border: 1.5px solid rgba(0,0,0,0.14); border-radius: 10px;
...
@media(max-width:520px){
    ...
    .steps-row { flex-wrap: wrap; gap: 8px; margin-bottom: 16px; }
    .step-dot { padding: 5px 10px; font-size: 0.74rem; }
    .form-title { font-size: 1.35rem; }
    .form-sub { font-size: 0.88rem; margin-bottom: 14px; }
    .terms-row { align-items: flex-start; line-height: 1.5; }
    .btn-register { padding: 13px 14px; font-size: 0.95rem; }
}
@media(max-width:375px){
    .auth-form-side { padding: 18px 12px 24px; }
    .mobile-brand img { height: 34px; }
    .form-control, .form-select { padding: 12px 12px 12px 36px; font-size: 0.92rem; }
    .f-icon { left: 12px; }
}
</style>
</head>
