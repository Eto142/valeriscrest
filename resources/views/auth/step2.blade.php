        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <div class="details-card">
                    ...
                    @if (session('success'))
                    <div style="background-color: rgba(34,197,94,0.1); color: #4ade80; border: 1px solid rgba(34,197,94,0.35); padding: 12px; border-radius: 6px; margin-bottom: 15px;">
                        {{ session('success') }}
                    </div>
                    @endif

                    @if (session('error'))
                    <div style="background-color: rgba(239,68,68,0.1); color: #f87171; border: 1px solid rgba(239,68,68,0.35); padding: 12px; border-radius: 6px; margin-bottom: 15px;">
                        {{ session('error') }}
                    </div>
                    @endif

                    @if ($errors->any())
                    <div style="background-color: rgba(82,175,238,0.1); color: #8ec9f0; border: 1px solid rgba(82,175,238,0.35); padding: 12px; border-radius: 6px; margin-bottom: 15px;">
                    ...
                    <div class="card-body p-4">
                        <form method="POST" action="{{ route('user.step2') }}" id="updateDetails">
                            @csrf
                            <div class="mb-3">
